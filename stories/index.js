...
storiesOf("Appointment", module)
  ...
  .add("Show", () => <Show student="Lydia Miller-Jones" interviewer="Sylvia Palmer"
  ...
  .add("Edit Form", () => <Form student="Valentin Vlad" interviewer={4} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
